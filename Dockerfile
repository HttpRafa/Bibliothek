...
ENV SPRING_CONFIG_LOCATION="optional:classpath:/,optional:classpath:/config/,file:./default.application.yml,optional:file:./,optional:file:./config/"
COPY ./docker/default.application.yml ./default.application.yml
